...
<li class="#"><a class="nav-link" href="<?= site_url("jurnalumum") ?>"><i class="fas fa-book"></i></i><span>Jurnal Umum</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url("posting") ?>"><i class="fas fa-calendar-alt"></i><span>Posting</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url("neracasaldo") ?>"><i class="fas fa-balance-scale"></i><span>Neraca Saldo</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url("neracalajur") ?>"><i class="fas fa-folder-open"></i><span>Neraca Lajur</span></a></li>
